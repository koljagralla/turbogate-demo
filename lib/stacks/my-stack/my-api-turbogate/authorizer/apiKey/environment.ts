...
// Purpose of thise file:           Declares the environment variables that your authorizer needs. All declared environment variables will be extracted and validated and be available in the `environment` parameter of your authorizers `main.ts`. The source data for the enviornment variables will be provided in the constructor of your generated turbogate class.
